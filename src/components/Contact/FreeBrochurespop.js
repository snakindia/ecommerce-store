...
render() {
  return (
      <MDBContainer>
            <div class="chat-button free-signup signup-fixed"><a onClick={this.toggle(14)} data-toggle="modal" style={{fontsize:'1rem !important', color:'#fff !important'}}>Free Brochures</a></div>
        ...
        <button type="button" class="close"  onClick={this.toggle(14)}>
              ...
              <h2 class="bha_heading_2 font-weight-bold text-black">Free Brochures</h2>
    ...
    >
      {({
        ...
        <form onSubmit={handleSubmit}>
                <p class="mt-3">Sign up to receive the lates infor on new Baghouse products, special offers and more.</p>
          <div class="row">
          <div class="col-sm-6 col-md-6">
                    <div class="form-group mb-1">
                      <label for="">Name *</label>
                      <input type="text" class="form-control" id="" name="fname" value={values.fname} onChange={handleChange}
